    ...
    public class ModelDB:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Parcel>().HasData(
                new Parcel {Id = 1, SenderFullName = "John Doe", DepartureCode = "2020", Weight = 1.5m, Destination = "Los Angeles", Cost = 50 },
                new Parcel {Id = 2, SenderFullName = "Alice Smith", DepartureCode = "0101", Weight = 2.3m, Destination = "Chicago", Cost = 65 },
                new Parcel {Id = 3, SenderFullName = "Bob Johnson", DepartureCode = "4021", Weight = 1.8m, Destination = "Houston", Cost = 55 },
                new Parcel {Id = 4, SenderFullName = "Emily Brown", DepartureCode = "1234", Weight = 3.1m, Destination = "Miami", Cost = 75 },
                new Parcel {Id = 5, SenderFullName = "Michael Wilson", DepartureCode = "5555", Weight = 2.0m, Destination = "Seattle", Cost = 60 },
                new Parcel {Id = 6, SenderFullName = "Samantha Taylor", DepartureCode = "0707", Weight = 2.5m, Destination = "New York", Cost = 70 }
                );
